...
// procesador con conjunto de instrucciones, con vectorizaciones diferentes, pero hay que encontrar cómo usarlo
// calculos faciles de vectorizar donde no hay dependencias de datos es posible utilizar estas intrinsecas, intel intrinsics guide
// vectorizacion es mucho mas eficiente con SoA
